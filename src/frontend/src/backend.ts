...
export class Backend implements backendInterface {
    ...
    async createMentor(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createMentor(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getMentorById(arg0: bigint): Promise<Mentor> {
        if (this.processError) {
            try {
                const result = await this.actor.getMentorById(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideoById(arg0: bigint): Promise<VideoSubmission> {
        if (this.processError) {
            try {
    ...
    async listMentors(arg0: string): Promise<Array<Mentor>> {
        if (this.processError) {
            try {
                const result = await this.actor.listMentors(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listVideos(arg0: string): Promise<Array<VideoSubmission>> {
        if (this.processError) {
            try {
    ...
    async submitVideo(arg0: string, arg1: string, arg2: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitVideo(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
